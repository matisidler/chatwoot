...
RSpec.describe Notification do
  ...
  context 'when push_title is called' do
    it 'returns appropriate title suited for the notification type conversation_creation' do
      ...
      expect(notification.push_message_title).to eq "Se ha creado una conversación (##{notification.primary_actor.display_id}) \
en #{notification.primary_actor.inbox.name}"
    end
    ...
    it 'returns appropriate title suited for the notification type conversation_assignment' do
      ...
      expect(notification.push_message_title).to eq "Se te ha asignado una conversación (##{notification.primary_actor.display_id})"
    end
    ...
    it 'returns appropriate title suited for the notification type assigned_conversation_new_message' do
      ...
      expect(notification.push_message_title).to eq "Se ha creado un nuevo mensaje en la conversación (##{notification.primary_actor.display_id})"
    end
